              ...
              dbc.Col(
                html.Div([
                  html.Span('Created By:',className="panel-title",
                    ...
                    html.H2('Omkesh Varshney',style={'color':'white'}),
              ...
              dbc.Col(
                html.Div([
                  html.Span('Linkedin',className="panel-title",
                    ...
                    html.H2(html.A("Linkedin Profile", href='https://www.linkedin.com/in/omkeshvar/', target="_blank",
                      style={'color':'white'})
                      ,),
                    html.H2(html.A("Github Profile", href='https://github.com/lifehackerr', target="_blank",
                      style={'color':'white'})
                      ,),
              ...
              dbc.Col(
                html.Div([
                  html.Span('Any Suggestion',className="panel-title",
                    ...
                    html.H2('omkeshvarshney999@gmail.com',style={'color':'white'})
